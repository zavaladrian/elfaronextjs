    ...
    <div className="bg-white text-center">
      <div className="mx-auto p-5 ">
        ...
        <div className="mx-auto max-w-lg md:grid md:max-w-none md:grid-cols-2">
          <div>
            <div>
              <h2 className="text-4xl text-gray-900 -mt-3 sm:mt-3 mb-3 sm:text-4xl sm:tracking-tight font-cinzel hover:underline">
                El Faro 1
              </h2>
          ...
          <div>
            <div>
              <h2 className="text-4xl text-gray-900 mt-6 mb-5 md:mt-3 md:mb-3 sm:text-4xl sm:tracking-tight font-cinzel hover:underline">
                El Faro 2
              </h2>
              <h2 className="text-3xl font-medium text-gray-900  sm:text-4xl sm:tracking-tight underline font-lobster">
                Riverside
